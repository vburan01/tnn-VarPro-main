"""
Train the MNIST t-NN classifier with standard Adam.

Typical run for reproducibility:
 python -m examples.mnist.ex_mnist_tensor
 --max_epochs 200 --n_train 1000 --n_val 10000 --n_test 10000 --width 10
 --batch_size 32 --lr 1e-3 --gamma 0.9 --step_size 100 --M dct --seed 42

Change --n_train to 5000, 10000, 20000, or 50000 to reproduce the other
training-size experiments. Results are written under experiments/tensor/.
"""
