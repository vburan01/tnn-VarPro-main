...
def setup_parser():
    ...
    parser.add_argument('--varpro', action='store_true', help='Use variable projection for last affine layer')
    parser.add_argument('--n_warmup', type=int, default=5, help='Number of warm-up epochs (standard GD) before VarPro')
    parser.add_argument('--max_grad_norm', type=float, default=1.0, help='Max gradient norm for encoder clipping during VarPro (None to disable)')
    return parser
